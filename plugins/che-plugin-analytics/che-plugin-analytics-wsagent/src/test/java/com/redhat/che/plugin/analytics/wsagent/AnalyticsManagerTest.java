...
public class AnalyticsManagerTest {
  ...
  public void setUp() throws Exception {
    ...
    when(httpUrlConnectionProvider.getHttpUrlConnection(Mockito.any())).thenReturn(urlConnection);
  ...
  public void sendWorkspaceUsedAfterPreviousEventExpectedDurationElapsed() throws Exception {
    ...
    verify(analytics, Mockito.timeout(AnalyticsManager.pingTimeoutSeconds * 1000).atLeast(2))
  ...
  public void sendPingRequest() throws Exception {
    ...
    verify(analytics, Mockito.timeout(AnalyticsManager.pingTimeoutSeconds * 1000).atLeast(1))
        .enqueue(argCaptor.capture());
    ...
    verify(urlConnection, Mockito.timeout(AnalyticsManager.pingTimeoutSeconds * 1000))
        .getInputStream();
    ...
    verify(httpUrlConnectionProvider, Mockito.timeout(AnalyticsManager.pingTimeoutSeconds * 1000))
